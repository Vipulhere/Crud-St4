 ...
 const a=  sdata.filter((user)=>{
  ...
  return (
    ...
    <div class="relative">
        ...
        <input onChange={handlechange} type="search" id="default-search" class="ml-1 mr-1 block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required/>
